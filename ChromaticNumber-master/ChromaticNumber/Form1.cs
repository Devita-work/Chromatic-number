...
namespace ChromaticNumber
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Хроматическое число гра́фа G — минимальное число цветов, в которые можно раскрасить вершины графа G так, чтобы концы любого ребра имели разные цвета." +
                "\nИспользуя данную программу вы можете построить собственный граф, сохранить его, открыть позже и найти хроматическое число");
